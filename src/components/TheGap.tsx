      ...
      <div className="max-w-4xl mx-auto">
        ...
        >
          ...
          <h2 className="text-4xl lg:text-7xl font-normal mb-12 leading-[1.1]">
            ...
            <span className="serif-italic text-art-accent">Synapse changes your child too.</span>
          </h2>
          <div className="grid md:grid-cols-2 gap-12 text-lg text-art-muted leading-relaxed font-light">
            ...
            <p>
              Synapse fills the gap between <span className="text-art-ink serif-italic">knowing</span> and <span className="text-art-ink serif-italic">doing</span>. By involving your child in the same scientific language and using a device accountability layer, we turn parenting advice into a shared family practice.
            </p>
          </div>
        </motion.div>
      </div>
