    ...
    <nav className="fixed top-0 left-0 w-full z-50 bg-art-bg/80 backdrop-blur-md border-b border-art-border">
      <div className="max-w-7xl mx-auto px-6 h-20 flex items-center justify-between">
        <div className="flex items-center gap-4">
          <div className="flex flex-col items-start leading-[0.8] border-r border-art-border pr-6 mr-2">
          ...
          <span className="text-xs uppercase tracking-widest text-art-muted hidden sm:block">Neuroscience / Parenting</span>
        </div>
